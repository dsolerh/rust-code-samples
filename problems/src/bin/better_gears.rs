fn main() {
    println!("engine schematics: {}", calculate_engine_schematic(DATA));
    println!("gear ratio: {}", calculate_gear_ratio(DATA));
}

fn calculate_gear_ratio(data: &str) -> i32 {
    ...
    symbols
        ...
        .filter_map(|symbol| {
            if symbol.ch == '*' {
                ...
                if near_numbers.len() == 2 {
                    return Some(
                        near_numbers.get(0).unwrap().number * near_numbers.get(1).unwrap().number,
                    );
                }
                return None;
            }
        ...
        // .inspect(|n| println!("number: {}", n.number))
        .sum()
}

fn calculate_engine_schematic(data: &str) -> i32 {
    let numbers = NumberPos::from_data(data);
    let symbols = SymbolPos::from_data(data);
    numbers
        .into_iter()
...
impl NumberPos {
    fn from_data(data: &str) -> Vec<Self> {
        data.lines()
            .map(str::trim)
            .enumerate()
            .flat_map(NumberPos::from_line)
            .collect()
    }

    fn from_line(data: (usize, &str)) -> Vec<Self> {
...
mod tests {
    ...
    fn test_number_pos_from_line() {
        let numers: Vec<_> = NumberPos::from_line((1, "467..114.."));
    ...
    fn test_number_pos_from_data() {
        let numbers: Vec<_> = NumberPos::from_data("467..114..\n...*......\n..35..633.");
    ...
    fn test_symbol_pos_from_line() {
        let symbols: Vec<_> = SymbolPos::from_line((4, "...$.*...."));
    ...
    fn test_symbol_pos_from_data() {
        let symbol: Vec<_> = SymbolPos::from_data("617*......\n.....+.58.\n..592.....");
    ...
    #[test]
    fn test_calculate_engine_schematic() {
        let total = calculate_engine_schematic(
            r"467..114..
        ...*......
        ..35..633.
        ......#...
    ...
    fn test_calculate_gear_ratio() {
        let total = calculate_gear_ratio(
            r"467..114..
        ...*......
        ..35..633.
        ......#...
...
const DATA: &str = r".........232.633.......................803..........................361................192............539.................973.221...340.....
